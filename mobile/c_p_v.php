        ...
        <div style='background:#fee;border-bottom:1px solid #faa;'>
          <table>
            <tr>
              ...
              <td>
                <a href='profile.php?view=$r[username]'>$r[firstname] $r[lastname]</a> &nbsp;&nbsp;
                <div style='word-wrap:break-word;color:#333'>$r[comment]</div><small class='text-muted'>$r[disp]</small><br />
              </td>
            </tr>
          </table>
        </div>

<?php
	...
	foreach($query as $r)
	{
		...
		echo "<div style='border-bottom:1px solid #aaa; padding:10px'><img src='$img' height='30px' width='30px'><a href='profile.php?view=$r[username]'> $r[firstname] $r[lastname] </a><span class='pull-right text-muted'>$r[disp]</span></div>";
	}
